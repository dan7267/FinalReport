...
# def simulate_subject(v, X, j, cond1, cond2, a, b, sigma, k, model_type, reset_after, paradigm, N, ind, sub_num, voxel_correlated_noise):
...
#         else:
#             mv_noise = 0
#         noise = np.random.randn(v, 196, sub_num) * 0.3 + mv_noise
...
#         noise = np.random.randn(v, 48, sub_num) * 0.3 + mv_noise
...
# def produce_slopes_one_simulation(paradigm, model_type, sigma, a, b, k, voxel_correlated_noise, n_jobs):
...
#     y = simulate_subject(v, X, j, cond1, cond2, a, b, sigma, k, model_type, reset_after, paradigm, N, ind, sub_num, voxel_correlated_noise)
#     return produce_slopes(y, 1, Kfold)
    
# def produce_confidence_intervals(paradigm, model_type, sigma, a, b, k, n_jobs, n_simulations, voxel_correlated_noise):
...
#         # print(sim)
#         slopes = produce_slopes_one_simulation(paradigm, model_type, sigma, a, b, k, voxel_correlated_noise, n_jobs)
#         # print(sim)
#         # print(slopes)
...
# def produce_model_key_variables(model, parameters, paradigm, experimental_results, n_simulations, n_jobs, voxel_correlated_noise):
...
#         sigma, a, b, k = combo
#         result_dict = produce_confidence_intervals(paradigm, model, sigma, a, b, k, n_jobs, n_simulations, voxel_correlated_noise)
...
# def producing_fig_5(parameters, paradigm, n_simulations, n_jobs, voxel_correlated_noise):
...
#     fig_5_dict = {
#         model: produce_model_key_variables(model, parameters, paradigm, experimental_results, n_simulations, n_jobs, voxel_correlated_noise)
...
# n_simulations = 50
# voxel_correlated_noise = 0


# results = producing_fig_5(good_spread_parameters, 'face', n_simulations, n_jobs, voxel_correlated_noise)

# with open("fig5_face_PMZP_Vcor0_03noise.txt", "w") as f:
...
# results = producing_fig_5(good_spread_parameters, 'grating', n_simulations, n_jobs, voxel_correlated_noise)

# with open("fig5_grating_PMZP_Vcor0_03noise.txt", "w") as f:
#     from pprint import pformat
#     f.write(pformat(results))
...
# with open("fig5_face_PMZP_Vcor05_03noise.txt", "w") as f:
#     from pprint import pformat
#     f.write(pformat(results))
...
print(results)
# with open("gratingforlotsofvcor.txt", "w") as f:
#     from pprint import pformat
#     f.write(pformat(results))

# results = producing_fig_5(good_spread_parameters, 'grating', n_simulations, n_jobs, voxel_correlated_noise[1])

# with open("fig5_grating_PMZP_Vcor035_03noise.txt", "w") as f:
#     from pprint import pformat
#     f.write(pformat(results))

# results = producing_fig_5(good_spread_parameters, 'grating', n_simulations, n_jobs, voxel_correlated_noise[2])

# with open("fig5_grating_PMZP_Vcor06_03noise.txt", "w") as f:
#     from pprint import pformat
#     f.write(pformat(results))

# results = producing_fig_5(good_spread_parameters, 'grating', n_simulations, n_jobs, voxel_correlated_noise[3])

# with open("fig5_grating_PMZP_Vcor085_03noise.txt", "w") as f:
#     from pprint import pformat
#     f.write(pformat(results))